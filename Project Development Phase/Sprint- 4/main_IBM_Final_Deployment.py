...
# NOTE: you must manually set API_KEY below using information retrieved from your IBM Cloud account.
    API_KEY = "KufU8xI0pGHxlmaw5ADDiRshUy51DwUG3KPwKxjxa9VN"
    ...
    if request.method=='POST':
        ...
        array_of_input_fields = [["min_temp","max_temp","rain","gust_dir","gust_speed","hum1","hum2","pres1","pres2","temp1","temp2"]]
        array_of_values_to_be_scored = [[min_temp,max_temp,rain,gust_dir,gust_speed,hum1,hum2,pres1,pres2,temp1,temp2]]
        payload_scoring = {"input_data": [{"fields": [array_of_input_fields], "values": [array_of_values_to_be_scored]}]}

        response_scoring = requests.post('https://us-south.ml.cloud.ibm.com/ml/v4/deployments/34776d6d-8d0d-422a-b63d-c2da76e69fa6/predictions?version=2022-11-20', json=payload_scoring,
